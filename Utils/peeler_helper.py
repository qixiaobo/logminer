...
def parse_arg():
    ...
    argument_parse.add_argument("-o", action="store", dest="outer_delimiter",
                                help="Outer delimiter as in the peeler file")
    argument_parse.add_argument("-l", action="store", dest="log_line",
                                help="The sampled log line encapsulated by quotation marks")
